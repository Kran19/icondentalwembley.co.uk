<?php
// treatments/repair-my-teeth.php
$current_page = 'treatments.php'; // For navbar active state
$page_title = "Repair My Teeth | Icon Dental Wembley";
...
<section class="subpage-hero">
    <div class="container custom-container">
        <div class="row align-items-center g-5">
            <!-- Left Column -->
            <div class="col-lg-6">
                <span class="hero-label">Repair My Teeth</span>
                <h1 class="hero-title">Restore Damaged & Decayed Teeth</h1>
                <p class="hero-desc">Rebuild structural integrity, treat decay, and eliminate pain with premium restorations designed to look and function exactly like your natural teeth.</p>
                ...
                <div class="hf-list">
                    <div class="hf-item">
                        ...
                        <div>
                            ...
                            <p>Rebuild structural tooth strength</p>
                        </div>
                    </div>
                    <div class="hf-item">
                        <div class="hf-icon-circle"><i class="fa-solid fa-shield-halved"></i></div>
                        <div>
                            <h4>Pain-Free Treatment</h4>
                            <p>Comfortable, expert procedures</p>
                        </div>
                    </div>
                    <div class="hf-item">
                        <div class="hf-icon-circle"><i class="fa-regular fa-face-smile"></i></div>
                        <div>
                            <h4>Natural Appearance</h4>
                            <p>Tooth-coloured aesthetic resins</p>
                        </div>
                    </div>
                    <div class="hf-item">
                        <div class="hf-icon-circle"><i class="fa-solid fa-heart-pulse"></i></div>
                        <div>
                            <h4>Durable Results</h4>
                            <p>Strong, long-lasting restorations</p>
                        </div>
                    </div>
                </div>
...
<section class="overview-section" id="overview">
    <div class="container custom-container">
        <p class="section-intro-text">
            At Icon Dental Wembley, our restorative dental services focus on repairing damaged, cracked, or decayed teeth. Using advanced techniques, custom-fabricated ceramic crowns, and tooth-colored restorations, we restore your mouth's natural function and comfort while preserving your visual smile aesthetics.
        </p>

        <h2 class="section-title-luxury">Our Restorative Services</h2>
    ...
    <div class="container custom-container">
        <div class="row g-5">
            <div class="col-md-6 comparison-col">
                <h3>Key Benefits of Restorative Care</h3>
                <ul class="comparison-list">
                    <li><i class="fa-solid fa-circle-check"></i> <strong>Saves Teeth:</strong> Root canal and crowns prevent tooth extraction.</li>
                    <li><i class="fa-solid fa-circle-check"></i> <strong>Restores Chew Force:</strong> Enjoy your favorite meals with full dental biting load.</li>
                    <li><i class="fa-solid fa-circle-check"></i> <strong>Premium Materials:</strong> Biocompatible ceramics blend naturally with your smile.</li>
                    <li><i class="fa-solid fa-circle-check"></i> <strong>Perfect Fit:</strong> Tailored shapes ensure comfortable occlusion alignment.</li>
                </ul>
            </div>
            <div class="col-md-6 comparison-col">
                <h3>Is this right for you?</h3>
                <ul class="comparison-list">
                    <li><i class="fa-solid fa-circle-check"></i> Recommended if you have visible cavities, chips, or fractures.</li>
                    <li><i class="fa-solid fa-circle-check"></i> Perfect if you experience temperature sensitivity when drinking.</li>
                    <li><i class="fa-solid fa-circle-check"></i> Essential if you have lost a crown or have dynamic chewing pain.</li>
                    <li><i class="fa-solid fa-circle-check"></i> Ideal for filling structural gaps to maintain your facial symmetry.</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="process-section">
    <div class="container custom-container">
        <h2 class="section-title-luxury">The Restoration Process</h2>
        <div class="process-timeline">
            <!-- Step 1 -->
            <div class="process-step">
                <div class="step-number">1</div>
                <h4 class="step-title">Initial Diagnostics</h4>
                <p class="step-desc">We use digital imaging to assess the damage and map out a precise restorative care plan.</p>
            </div>
            <!-- Step 2 -->
            <div class="process-step">
                <div class="step-number">2</div>
                <h4 class="step-title">Dental Preparation</h4>
                <p class="step-desc">The decayed or weak structure is carefully removed under comfortable local anesthesia.</p>
            </div>
            <!-- Step 3 -->
            <div class="process-step">
                <div class="step-number">3</div>
                <h4 class="step-title">Custom Restoration</h4>
                <p class="step-desc">High-quality composite or ceramic restorations are precisely shaped and bonded to the tooth.</p>
            </div>
            <!-- Step 4 -->
            <div class="process-step">
                <div class="step-number">4</div>
                <h4 class="step-title">Bite Calibration</h4>
                <p class="step-desc">We check and adjust the bite alignment to ensure a highly comfortable, natural function.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="gallery-section">
    <div class="container custom-container">
        <h2 class="section-title-luxury">Restoration Before & After</h2>
...
<div class="container custom-container">
    <div class="testimonial-banner-custom">
        ...
        <p class="tb-quote-text">
            "I had a root canal and a crown done here, and I felt absolutely nothing. The level of care, hygiene, and expertise is truly world-class!"
        </p>
        <span class="tb-author">Sarah M. — Wembley</span>
    </div>
</div>
        ...
        <div class="faq-accordion">
            ...
            <div class="faq-item">
                <button class="faq-header-btn" onclick="toggleFaq(this)">
                    <span>Do tooth-colored fillings look natural?</span>
                    <i class="fa-solid fa-chevron-down faq-icon-arrow"></i>
                </button>
                <div class="faq-content">
                    <div class="faq-content-inner">
                        Yes, composite fillings are matched precisely to your existing tooth shade, creating a seamless, invisible restoration that blends naturally when you smile.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item">
                <button class="faq-header-btn" onclick="toggleFaq(this)">
                    <span>Is a root canal painful?</span>
                    <i class="fa-solid fa-chevron-down faq-icon-arrow"></i>
                </button>
                <div class="faq-content">
                    <div class="faq-content-inner">
                        No, modern local anesthetics ensure you are completely numb during the procedure. Most patients describe a root canal as feeling no different than receiving a standard filling.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item">
                <button class="faq-header-btn" onclick="toggleFaq(this)">
                    <span>How long do dental crowns last?</span>
                    <i class="fa-solid fa-chevron-down faq-icon-arrow"></i>
                </button>
                <div class="faq-content">
                    <div class="faq-content-inner">
                        With proper care, regular brushing, flossing, and check-ups, high-quality porcelain or zirconia dental crowns can easily last between 10 to 15 years, and often much longer.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item">
                <button class="faq-header-btn" onclick="toggleFaq(this)">
                    <span>When is a dental bridge needed?</span>
                    <i class="fa-solid fa-chevron-down faq-icon-arrow"></i>
                </button>
                <div class="faq-content">
                    <div class="faq-content-inner">
                        A bridge is used to replace one or more missing teeth by anchoring a prosthetic tooth to the strong teeth on either side of the gap, preventing shifts in dental spacing.
                    </div>
                </div>
            </div>
        </div>
...
<section class="container custom-container mb-5 pb-5">
    <div class="subpage-cta-banner">
        <div class="subpage-cta-left">
            <h3>Start Your Restorative Journey</h3>
            <p>Schedule your consultation today to restore strength and comfort to your teeth.</p>
        </div>
        <a href="<?php echo $base_url; ?>/book-online.php" class="btn-cta-luxury">
