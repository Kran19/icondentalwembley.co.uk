<?php
// treatments/facial-aesthetics.php
$current_page = 'treatments.php'; // For navbar active state
$page_title = "Facial Aesthetics | Icon Dental Wembley";
...
<section class="subpage-hero">
    <div class="container custom-container">
        <div class="row align-items-center g-5">
            <!-- Left Column -->
            <div class="col-lg-6">
                <span class="hero-label">Facial Aesthetics</span>
                <h1 class="hero-title">Refresh Your Natural Appearance</h1>
                <p class="hero-desc">Rejuvenate your appearance and enhance your natural facial contours with anti-wrinkle injections, dermal fillers, lip plumping, and personalized skincare rejuvenation.</p>
                
                <div class="hf-list">
                    <div class="hf-item">
                        <div class="hf-icon-circle"><i class="fa-solid fa-user-doctor"></i></div>
                        <div>
                            <h4>Clinical Expertise</h4>
                            <p>Administered by certified medical experts</p>
                        </div>
                    </div>
                    <div class="hf-item">
                        <div class="hf-icon-circle"><i class="fa-solid fa-shield-halved"></i></div>
                        <div>
                            <h4>Reversible Fillers</h4>
                            <p>Safe, premium hyaluronic acid gels</p>
                        </div>
                    </div>
                    <div class="hf-item">
                        <div class="hf-icon-circle"><i class="fa-regular fa-face-smile"></i></div>
                        <div>
                            <h4>Soft Refreshment</h4>
                            <p>Subtle, natural-looking aesthetics</p>
                        </div>
                    </div>
                    <div class="hf-item">
                        ...
                        <div>
                            ...
                            <p>Fast treatment with zero downtime</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                <div class="hero-image-wrapper">
                    <img src="../assets/images/reception.png" alt="Facial aesthetics at Icon Dental Wembley">
                </div>
            </div>
        </div>
    </div>
...
<section class="overview-section" id="overview">
    <div class="container custom-container">
        <p class="section-intro-text">
            At Icon Dental Wembley, our facial aesthetic treatments are designed to highlight your natural beauty and boost skin vitality. Administered by fully qualified clinical experts, our non-surgical solutions help reduce signs of aging and refresh your features safely and comfortably.
        </p>

        <h2 class="section-title-luxury">Our Aesthetics Services</h2>
    ...
    <div class="container custom-container">
        <div class="row g-5">
            <div class="col-md-6 comparison-col">
                <h3>Key Benefits of Facial Care</h3>
                <ul class="comparison-list">
                    <li><i class="fa-solid fa-circle-check"></i> <strong>Refreshed Look:</strong> Smooths dynamic expression lines without surgery.</li>
                    <li><i class="fa-solid fa-circle-check"></i> <strong>Natural Contours:</strong> Accentuates cheekbones, lips, and jaw definitions.</li>
                    <li><i class="fa-solid fa-circle-check"></i> <strong>Instant Hydration:</strong> Hyaluronic acid binds water molecules for a plump finish.</li>
                    <li><i class="fa-solid fa-circle-check"></i> <strong>Clinically Supervised:</strong> Completed by fully insured dental experts in a sterile room.</li>
                </ul>
            </div>
            <div class="col-md-6 comparison-col">
                <h3>Is this right for you?</h3>
                <ul class="comparison-list">
                    <li><i class="fa-solid fa-circle-check"></i> Ideal for patients wanting to soften dynamic expression lines.</li>
                    <li><i class="fa-solid fa-circle-check"></i> Perfect if you wish to restore lost mid-face or under-eye volume.</li>
                    <li><i class="fa-solid fa-circle-check"></i> Great for enhancing lip volume or defining lip borders.</li>
                    <li><i class="fa-solid fa-circle-check"></i> Best if you desire clinical-grade skincare enhancements.</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="process-section">
    <div class="container custom-container">
        <h2 class="section-title-luxury">Your Treatment Journey</h2>
        <div class="process-timeline">
            <!-- Step 1 -->
            <div class="process-step">
                <div class="step-number">1</div>
                <h4 class="step-title">Initial Mapping</h4>
                <p class="step-desc">We examine your facial structure, muscle movement, and skin texture to map out a safe treatment plan.</p>
            </div>
            <!-- Step 2 -->
            <div class="process-step">
                <div class="step-number">2</div>
                <h4 class="step-title">Skin Preparation</h4>
                <p class="step-desc">The treatment area is cleansed, and a topical numbing cream is applied to ensure full comfort.</p>
            </div>
            <!-- Step 3 -->
            <div class="process-step">
                <div class="step-number">3</div>
                <h4 class="step-title">Precise Care</h4>
                <p class="step-desc">The product is gently and precisely injected by our clinician using specialized micro-needles.</p>
            </div>
            <!-- Step 4 -->
            <div class="process-step">
                <div class="step-number">4</div>
                <h4 class="step-title">Aftercare Review</h4>
                <p class="step-desc">We provide post-treatment advice and schedule a follow-up review to ensure optimal results.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="gallery-section">
    <div class="container custom-container">
        <h2 class="section-title-luxury">Aesthetic Presentation Results</h2>
...
<div class="container custom-container">
    <div class="testimonial-banner-custom">
        ...
        <p class="tb-quote-text">
            "I am so pleased with my subtle lip enhancement. It looks so natural and refreshed. Dr Kishan was absolutely amazing!"
        </p>
        <span class="tb-author">Emily R. — Wembley</span>
    </div>
</div>
        ...
        <div class="faq-accordion">
            ...
            <div class="faq-item">
                <button class="faq-header-btn" onclick="toggleFaq(this)">
                    <span>How long do anti-wrinkle injections last?</span>
                    <i class="fa-solid fa-chevron-down faq-icon-arrow"></i>
                </button>
                <div class="faq-content">
                    <div class="faq-content-inner">
                        The effects of anti-wrinkle injections typically last between 3 to 4 months. As muscle action gradually returns, the lines will slowly begin to reappear and require retreatment.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item">
                <button class="faq-header-btn" onclick="toggleFaq(this)">
                    <span>Are dermal fillers safe and temporary?</span>
                    <i class="fa-solid fa-chevron-down faq-icon-arrow"></i>
                </button>
                <div class="faq-content">
                    <div class="faq-content-inner">
                        Yes, we use dermal fillers composed of hyaluronic acid—a sugar molecule found naturally in the body. They are biocompatible, fully temporary, and naturally dissolve over 6 to 12 months. They can also be reversed if needed.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item">
                <button class="faq-header-btn" onclick="toggleFaq(this)">
                    <span>Is there any downtime after treatments?</span>
                    <i class="fa-solid fa-chevron-down faq-icon-arrow"></i>
                </button>
                <div class="faq-content">
                    <div class="faq-content-inner">
                        There is minimal to no downtime. You can return to normal activities immediately. Some patients experience minor redness, swelling, or localized bruising at the injection sites, which resolves in 24–48 hours.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item">
                <button class="faq-header-btn" onclick="toggleFaq(this)">
                    <span>What does skin rejuvenation involve?</span>
                    <i class="fa-solid fa-chevron-down faq-icon-arrow"></i>
                </button>
                <div class="faq-content">
                    <div class="faq-content-inner">
                        Skin rejuvenation utilizes advanced non-surgical techniques, such as chemical peels, microneedling, or facial mesotherapy, to boost cell turnover, improve skin texture, and restore collagen for a healthy glow.
                    </div>
                </div>
            </div>
        </div>
...
<section class="container custom-container mb-5 pb-5">
    <div class="subpage-cta-banner">
        <div class="subpage-cta-left">
            <h3>Start Your Aesthetic Journey</h3>
