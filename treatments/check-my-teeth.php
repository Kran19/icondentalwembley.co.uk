<?php
// treatments/check-my-teeth.php
$current_page = 'treatments.php'; // For navbar active state
$page_title = "Check My Teeth | Icon Dental Wembley";
...
<section class="subpage-hero">
    <div class="container custom-container">
        <div class="row align-items-center g-5">
            <!-- Left Column -->
            <div class="col-lg-6">
                <span class="hero-label">Check My Teeth</span>
                <h1 class="hero-title">Routine Dental Check-ups & Diagnosis</h1>
                <p class="hero-desc">Maintain excellent oral health with regular assessments, advanced diagnostics, same-day emergency relief, and gentle hygiene cleanings customized to protect your smile.</p>
                ...
                <div class="hf-list">
                    <div class="hf-item">
                        ...
                        <div>
                            ...
                            <p>Active protection for teeth and gums</p>
                        </div>
                    </div>
                    <div class="hf-item">
                        ...
                        <div>
                            ...
                            <p>Identify dental issues early</p>
                        </div>
                    </div>
                    <div class="hf-item">
                        <div class="hf-icon-circle"><i class="fa-regular fa-face-smile"></i></div>
                        <div>
                            <h4>Gentle Hygiene</h4>
                            <p>Painless cleaning and polishing</p>
                        </div>
                    </div>
                    <div class="hf-item">
                        ...
                        <div>
                            ...
                            <p>Prompt support when in pain</p>
                        </div>
                    </div>
                </div>
...
<section class="overview-section" id="overview">
    <div class="container custom-container">
        <p class="section-intro-text">
            At Icon Dental Wembley, we believe that prevention is better than cure. Regular dental examinations and professional cleanings are the foundation of a healthy smile. Our diagnostic techniques help catch potential problems before they require complex treatment, ensuring your teeth stay strong and functional for years to come.
        </p>

        <h2 class="section-title-luxury">Our Diagnostic & Preventive Services</h2>
    ...
    <div class="container custom-container">
        <div class="row g-5">
            <div class="col-md-6 comparison-col">
                <h3>Key Benefits of Routine Care</h3>
                <ul class="comparison-list">
                    <li><i class="fa-solid fa-circle-check"></i> <strong>Early Cavity Prevention:</strong> Stops tooth decay before it spreads to nerves.</li>
                    <li><i class="fa-solid fa-circle-check"></i> <strong>Protects Gum Tissue:</strong> Keeps gums firm and prevents bad breath (halitosis).</li>
                    <li><i class="fa-solid fa-circle-check"></i> <strong>Saves Time & Expenses:</strong> Minor treatments now avoid expensive root canals or extractions later.</li>
                    <li><i class="fa-solid fa-circle-check"></i> <strong>Re-mineralizes Enamel:</strong> Expert application of fluoride and polish hardens enamel.</li>
                </ul>
            </div>
            <div class="col-md-6 comparison-col">
                <h3>Is this right for you?</h3>
                <ul class="comparison-list">
                    <li><i class="fa-solid fa-circle-check"></i> Ideal for families looking to establish lifelong dental health routines.</li>
                    <li><i class="fa-solid fa-circle-check"></i> Perfect if you experience bleeding gums, swelling, or sensitive teeth.</li>
                    <li><i class="fa-solid fa-circle-check"></i> Highly recommended if you haven't seen a dentist in the last 6 months.</li>
                    <li><i class="fa-solid fa-circle-check"></i> Essential for anyone requiring immediate relief from severe dynamic toothaches.</li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="process-section">
    <div class="container custom-container">
        <h2 class="section-title-luxury">What to Expect During Your Visit</h2>
        <div class="process-timeline">
            <!-- Step 1 -->
            <div class="process-step">
                <div class="step-number">1</div>
                <h4 class="step-title">Welcome & Consultation</h4>
                <p class="step-desc">We review your medical history and discuss any specific concerns or pain you may be experiencing.</p>
            </div>
            <!-- Step 2 -->
            <div class="process-step">
                <div class="step-number">2</div>
                <h4 class="step-title">Thorough Assessment</h4>
                <p class="step-desc">We visually inspect your teeth, gums, occlusion (bite), and take digital X-rays to assess beneath the surface.</p>
            </div>
            <!-- Step 3 -->
            <div class="process-step">
                <div class="step-number">3</div>
                <h4 class="step-title">Gentle Cleaning</h4>
                <p class="step-desc">Our hygienist scales away hard calculus, followed by advanced polishing to clean and brighten your enamel.</p>
            </div>
            <!-- Step 4 -->
            <div class="process-step">
                <div class="step-number">4</div>
                <h4 class="step-title">Care Plan & Advice</h4>
                <p class="step-desc">We outline any required treatment transparently, with options, pricing, and home care tips.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="gallery-section">
    <div class="container custom-container">
        <h2 class="section-title-luxury">Hygiene & Gum Care Results</h2>
...
<div class="container custom-container">
    <div class="testimonial-banner-custom">
        ...
        <p class="tb-quote-text">
            "The check-up and hygiene visit at Icon Dental Wembley was completely painless. The staff are so gentle, modern, and took their time to explain everything clearly!"
        </p>
        <span class="tb-author">David L. — Wembley</span>
    </div>
</div>
...
<section class="faq-section" id="faq">
    <div class="container custom-container">
        ...
        <div class="faq-accordion">
            ...
            <div class="faq-item">
                ...
                <div class="faq-content">
                    <div class="faq-content-inner">
                        For most patients, we recommend a routine check-up and professional hygiene cleaning every 6 months. Patients with active gum disease or specific health conditions may benefit from more frequent visits.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item">
                <button class="faq-header-btn" onclick="toggleFaq(this)">
                    <span>What happens during a professional hygiene clean?</span>
                    <i class="fa-solid fa-chevron-down faq-icon-arrow"></i>
                </button>
                <div class="faq-content">
                    <div class="faq-content-inner">
                        The hygienist uses ultrasonic scalers and hand instruments to scrape away plaque and tartar (hard calculus) that regular brushing cannot remove. Your teeth are then polished, and you receive customized guidance on brushing and flossing at home.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item">
                <button class="faq-header-btn" onclick="toggleFaq(this)">
                    <span>Is gum disease treatable?</span>
                    <i class="fa-solid fa-chevron-down faq-icon-arrow"></i>
                </button>
                <div class="faq-content">
                    <div class="faq-content-inner">
                        Yes, early-stage gum disease (gingivitis) is fully reversible with professional cleaning and good home hygiene. Advanced gum disease (periodontitis) is not curable but can be effectively managed and stabilized to prevent further gum recession and tooth loss.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item">
                ...
                <div class="faq-content">
                    <div class="faq-content-inner">
                        Severe dynamic toothache, swelling of the gums or face, a broken tooth causing sharp pain or bleeding, or a dental crown that has fallen out are all emergencies. Contact us immediately for same-day urgent care.
                    </div>
                </div>
            </div>
        </div>
...
<section class="container custom-container mb-5 pb-5">
    <div class="subpage-cta-banner">
        <div class="subpage-cta-left">
            <h3>Start Your Preventive Care Journey</h3>
